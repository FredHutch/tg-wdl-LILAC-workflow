...
```{r}
batchFileName <- paste0("cromwell-manifests/",format(Sys.Date(), "%Y-%m-%d-"), "duel-4.1.4.0-test1.tsv")
...
thisJob <- cromwellSubmitBatch(WDL = "duelingBanjos_GATK4.1.4.0.wdl",
                    Params = "duel_parameters_4.1.4.0_hg19.json",
                    Batch = "duel_batch.json",
                    Options = "workflow-options.json",
                    Labels = data.frame("workflowType" = "first one after v10 4.1.4.0"))
...
workflowFiles <-  "./Workflows/validatetwoworkflows/copy-91291e5c-8c64-4df4-b1e1-ae636c9f2f31//gizmo"
```
